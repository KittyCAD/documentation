---
title: 'Security'
excerpt: 'Information about how KittyCAD secures the product and vulnerability disclosure.'
---
...
We _will_ pay bounties for the following types of vulnerabilities if a researcher
...
- Any script kitty (no pun intended) off-the-shelf script that does not prove
    one of the vulnerabilities above.
