...
You will see your API token below if you are signed in and have already generated one. If you see "Generate your first API token," then you currently do not have a token. Follow the steps below to generate an API key:
...
Once you have executed an API command from your computer, it is time for you to execute a command directly from your computer. 
