...
Unlike memory, your files take up storage space even when they're not open. So, closing a file doesn't free up storage space. You have to delete the file to free up storage space. Programs like [Disk Inventory X](https://www.derlien.com/) let you visualize which files are taking up the most space on your computer, so you can delete unimportant files and get that space back.
