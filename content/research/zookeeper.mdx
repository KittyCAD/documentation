...
excerpt: 'Zookeeper is the conversational CAD agent built into Zoo Design Studio. Our goal in developing Zookeeper is to speed up CAD workflows, automate the toil in design work, and enable designers and engineers of all skill levels to more efficiently produce manufacturable, high-quality 3D designs.'
coverImage: '/documentation-assets/meta-images/research-zookeeper.png'
date: '2026-02-05'
author:
    name: 'Greg Sweeney'
    picture: '/documentation-assets/gregsweeney.jpeg'
ogImage:
    url: '/documentation-assets/meta-images/research-zookeeper.png'
tags: ['Zookeeper']
---
...
![A Comparison of Geometry Representation Schemes](/documentation-assets/research/zookeeper/geometric_representations.png)
