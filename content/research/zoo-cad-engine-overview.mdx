...
At Zoo, we aim to address this problem by maintaining a minimal set of geometric primitives. Rather
than implementing specialized representations for features like fillets, we represent these as
B-splines with specific constraints. This way, operations only need to handle B-splines, allowing us
to develop highly optimized, GPU-friendly algorithms like our surface-surface intersection method.
By avoiding the combinatorial explosion of primitive interactions, we can achieve significant
...
<figure>
    ...
    <img
        ...
        title=""
    />
    <figcaption> Figure 19: Two intersecting surfaces, one shown as a densely sampled cloud of points.</figcaption>
</figure>
