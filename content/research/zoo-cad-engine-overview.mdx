...
In contrast, Siemens NX had roots in aerospace (McDonnell Douglas). Sophisticated curved surfaces geometries
...
resources than are strictly required to perform the task at hand. Running all of this
software on anything but the highest performance computer hardware can be a recipe for performance 
problems that significantly degrade the user experience.
...
{/* TODO: Address Mike's comment. */}
{/* More on this needed. Possibly tag in Adam C here. */}
