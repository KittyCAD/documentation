...
excerpt: |
    An summary of the motivations and methodologies behind the Zoo CAD Engine.
...
{/* TODO: Remove any unused images from corresponding asset dir. */}
...
{/* TODO: Lockheed -> McDonnel Douglas, See: https://en.wikipedia.org/wiki/Siemens_NX */}

In contrast, Siemens NX had roots in aerospace (Lockheed). Sophisticated curved surfaces geometries
like airfoils or turbine blades were fundamental and were often the start point for design.
Precision could mean the difference between success or failure. Robust solid modeling underpinned
critical mass properties and physics simulations. The user interface was, as a result, much deeper
and more intricate, often requiring years to fully master. (The user license was, as a consequence,
far more expensive).
...
{/* Note that i’ve made some of these arguments before (almost verbatim) on our discord, but i doubt ppl will notice or care. */}

### 1.2: A Comparson Between CAD and Game Engines
...
resources than are actually required to perform its task (word this better). Running all of this
software on a single low-end (word this better) computer can be a recipe for performance problems
that degrade the user experience to the point of frustration.

{/* TODO: Address Mike's comment. */}
{/* This section isn’t done. */}
{/* Also need to have others review and scrutinize this, make sure i’m not talking out of my ass here. */}
...
{/* TODO: Address Mike's comment. */}
{/* _More on this needed. Possibly tag in Adam C here._ */}

### 2.2 Modelling Paradigms

Being that B-Rep is a standard starting ground for CAD representations. They offer parametric,
...
{/* $$
S(u, v) = \frac{
        \sum_{i=0}^{n} \sum_{j=0}^{m} N_{i,p}(u)N_{j,q}(v)w_{i,j} \mathbf{P}_{i,j}
    }
    {
...
Figure 7 and Figure 8 show the transformed (re-oriented) section instances, while Figure 9 shows the
...
The astute reader might notice that the trajectory curve from figure 3b can be decomposed into a
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image39.png"
        title=""
    />
    <img
        alt="Curve Segmentation by Max Curvature"
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image26.png"
    />
    <img
        alt="Surface Intersection Curve Example"
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image36.gif"
        title=""
    />
    <img
        alt="Trimming Example"
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image27.png"
        title=""
    />
    <img
        alt="Marching Intersection Method"
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image28.png"
        title=""
    />{' '}
    -->
    <img
    ...
    <figcaption>
        {' '}
        Figure 19: Two intersecting surfaces, one shown as a densely sampled cloud
        of points.
    </figcaption>
</figure>
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image23.png"
        title=""
    />
    <img
        alt="Cylinder Intersection Point Cloud"
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image20.jpg"
        title=""
    />
    <img
        alt="LOD SSI Points for Cylinders"
...
<figure>
    <img
        ...
        src="/documentation-assets/research/zoo-cad-engine-overview/image33.png"
        title=""
    />
    <img
        alt="SSI with Classified Points"
    ...
    <figcaption>
        {' '}
        Figure 25: SSI in object space (left) and parameter space uv-points classified
        by joints (green), end points (red), and simple branch points (black).
    </figcaption>
</figure>
...
<figure>
    ...
    <figcaption>
        {' '}
        Figure 27. Final step in SSI routine, the red intersection curve on the top.
    </figcaption>
</figure>
...
{/* Any references to technical papers, PhD theses (e.g., Adarsh Krishnamurthy’s work), and relevant sources on SSI and GPU processing. */}

{/* ## Acknowledgements */}

{/* TODO: Address Mike's comment. */}

{/* Grateful for many discussions with Mike. Max cast a scrutinizing eye over the entire process. Many others added bits and pieces. You know who you are! */}
