...
<figure>
    ...
    />
    <figcaption>
        Figure 1: SketchUp. A user-friendly, conceptual tool with polygon-based modeling.
        <br />
...
<figure>
    ...
    />
    <figcaption>
        Figure 2: Siemens NX. A precision engineering tool with NURBS-based modeling.
        <br />
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 4 - A semi-circular profile curve, suitable as a sweep section.</figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 5: Sweep profile and perpendicular trajectory curve.</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>
        Figure 10 - The swept solid B-Rep formed as a combination of extrudes and revolves as a join
        of 10 separate faces
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>
        Figure 11: Segments computed both analytically and with finite differences. Analytical
        segments are solid, with finite difference dotted. This shows that the faster finite
        difference method is very close to the analytical one.
    </figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 12: Examples of linear, circular, and array patterns.</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>
        Figure 13: The meeting of two surfaces creates difficult-to-find intersection curves.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>
        Figure 14: Easily manipulated mesh and control points (shown in blue) dictate the shape of a
        smooth object.
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>Figure 18: “Marching” an intersection between two NURBS.</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>
        Figure 19: Two intersecting surfaces, one shown as a densely sampled cloud of points.
    </figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 20: Two cylindrical surfaces and their SSI as points.</figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 21: SSI points at two levels of detail for crossed cylinders.</figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 22: SSI points (red) between green and gridded surfaces.</figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 23: The uv parameter points of the points in Figure 24.</figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 24: MAT applied to the point set in Figure 23.</figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>
        Figure 25: SSI in object space (left) and parameter space uv-points classified by joints
        (green), end points (red), and simple branch points (black).
    </figcaption>
</figure>
...
<figure>
    ...
    />
    <figcaption>
        Figure 26: A single branch of uv points which have been convolved with a hat filter, and
        then fit with a cubic interpolation spline.
    </figcaption>
</figure>
...
<figure>
    <img
        ...
        title=""
    />
    <figcaption>Figure 28. A good SSI is modest, unassuming, and works!</figcaption>
</figure>
