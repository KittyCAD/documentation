...
- **In the Zoo Design Studio**: Our flagship modeling software is tightly integrated with
...
<figure>
  <img alt="Zoo Design Studio" src="/documentation-assets/research/introducing-text-to-cad/image5.png" />
  <figcaption>Figure 2: Zoo Design Studio, Text-to-CAD Prompting</figcaption>
</figure>

<figure>
  <img alt="Zoo Design Studio" src="/documentation-assets/research/introducing-text-to-cad/image3.png" />
