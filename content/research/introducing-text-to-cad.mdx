...
[^A]:
    It's worth noting that a mesh is technically a form of boundary representation, but its boundary
    provides an imprecise approximation, particularly for curved geometry.
