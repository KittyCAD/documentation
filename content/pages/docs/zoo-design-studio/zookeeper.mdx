...
Zookeeper keeps its own working documents in the project as well, such as `NOTES.md`,
`CHECKLIST.md`, and `MEMORY.md`. It creates and updates those on its own judgment, and leaves
`AGENTS.md` to you.
