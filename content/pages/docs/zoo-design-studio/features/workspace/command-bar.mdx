...
**Import:** Import from project file (STEP, GLB, FBX, KCL) with local variable binding.
...
**Delete:** Remove selected bodies from the model while keeping the features that created them. See
[Delete](/docs/zoo-design-studio/features/3d-design/parametric-modeling/transforms/delete) for selection and workflow details.
...
**Capture screenshot:** Save the visible modeling viewport as `viewport-screenshot.png`. See
[Capture Screenshot](/docs/zoo-design-studio/features/data-management/export/capture-screenshot) for
details.
...
| **Toolbar** | Visual users, common modeling actions | Discoverable, mouse-friendly, always nearby |
