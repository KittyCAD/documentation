...
scope is unambiguous. You can ask Zookeeper to create or update it, for example:
...
[Reveal in file explorer](/docs/zoo-design-studio/features/workspace/file-explorer) and edit the file
with a text editor.
