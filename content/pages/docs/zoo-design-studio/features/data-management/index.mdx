...
KCL files for model logic and `project.toml` for project metadata. That makes projects portable,
inspectable, syncable, and practical to version with normal developer tools.
...
- [Default Project Folder](/docs/zoo-design-studio/features/data-management/default-project-folder)
  covers the legacy single-folder project setting.
