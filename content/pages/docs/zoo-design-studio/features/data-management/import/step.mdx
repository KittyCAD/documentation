...
With the STEP file in Project Files, use the Import action to add the import statement to the
...
<FramedImage
  ...
  alt="Using the Project Files Import action to add a STEP import statement to main.kcl"
  aspect="1280 / 733"
  maxHeightPx="780"
/>
<br />
<div>
  Use the Import action from Project Files to add the STEP import line to `main.kcl`
</div>
