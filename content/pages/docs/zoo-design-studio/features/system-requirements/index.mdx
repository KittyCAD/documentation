...
CAD engine session on Zoo's cloud compute infrastructure and streams the rendered viewport back to
your computer. This means Zoo Design Studio is not limited by the CAD hardware inside your local
machine, though a stable network connection is still important for responsive modeling.
