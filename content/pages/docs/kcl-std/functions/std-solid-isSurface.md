...
<model-viewer
  class="kcl-example"
  alt="Example showing a rendered KCL program that uses the isSurface function"
  src="/kcl-test-outputs/models/serial_test_example_fn_std-solid-isSurface0_output.gltf"
  ar
  environment-image="/moon_1k.hdr"
  poster="/kcl-test-outputs/serial_test_example_fn_std-solid-isSurface0.png"
  shadow-intensity="1"
  camera-controls
  touch-action="pan-y"
>
