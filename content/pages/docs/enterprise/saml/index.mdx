...
You can configure SAML SSO for an individual organization in your enterprise. 
...
| `SessionNotOnOrAfter` | ✘ |		The date that Zoo invalidates the associated session. After invalidation, the person must authenticate once again to access your enterprise's resources. For more information, see "Session duration and timeout." |
