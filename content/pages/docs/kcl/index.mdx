...
For more context on why Zoo made a programming language the foundation of its CAD system, read [KCL: A Programming Language for Parametric CAD](/research/introducing-kcl). It explains how readable text, collaboration, automation, and reusable code make KCL a natural fit for modern parametric design.
...
- Browse the [CAD Samples Gallery](/aquarium) when you want real KCL projects to adapt.
