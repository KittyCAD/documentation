...
**Account Deletion**. To request deletion of your Zoo account, sign in and use **Delete account** in your [account settings](/account#delete-account). Review the deletion information and confirm your request. If the deletion control is unavailable or you need assistance, email [support@zoo.dev](mailto:support@zoo.dev). Personal information may be retained as described in “[Data Retention](#6-data-retention)” below. You can also request deletion of your personal information through the privacy-rights process below.
