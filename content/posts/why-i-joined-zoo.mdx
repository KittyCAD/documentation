...
ogImage:
    url: 'documentation-assets/meta-images/why-i-joined-zoo-blog.jpg'
---
...
To give some idea of how these work in practice, here are three representations of both a circle and a sphere.

![circle-representations](/documentation-assets/why-i-joined-zoo/geometric_representations.png)

The first is broadly how a B-rep would work. It's an accurate mathematical description of the shape. The second is an implicit representation, where we evaluate a function whose result gets further from zero the further we move from the object's perimeter. The third is a polygonal mesh, where we've sampled the object around its boundary, and—at least in the spherical case—approximated the shape with a set of triangles.
