...
## The case for a new kernel

I touched on this above, but are some exceptions to this rule, with products from Autodesk, Dassault Systèmes, and PTC making use of their own modeling kernel, but nevertheless, the majority of the western world's systems make use of Parasolid (first released as Romulus in 1978) or ACIS (first released in 1989).

![software-syste-kernels](/documentation-assets/why-i-joined-zoo/software_system_kernels.png)
