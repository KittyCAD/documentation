...
Sat on a train from Belfast to Dublin, I spent a bit of time looking for web pages that
offered some kind of Morse code practice, and generally didn't find anything quite right.
This formed an opportunity and an interesting challenge: could I build a relatively
entertaining mechanism for teaching myself Morse code?
