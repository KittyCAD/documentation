...
At launch, your card was automatically charged at the end of the month and we emailed you an itemized receipt showing all the API calls you made and their prices. Free credits then reset on the first of every month.[^2026-billing-calendar-update] You were notified via email once you used all your free credits. If you made more than 250 billable API calls in a month, you were charged and emailed a receipt before the end of the month, right after the 250th API call. This was due to a limit in invoice items per invoice: we needed to bill you to start a new invoice for future charges.[^2]
...
[^2026-billing-calendar-update]: Update September 1, 2026: Included monthly usage now refreshes at each account's monthly anniversary boundary, evaluated in UTC, rather than on the first day of the calendar month. Monthly versus annual payment cadence does not change the monthly usage-refresh cadence. See the [billing FAQ](/docs/faq#when-does-my-included-usage-renew-and-does-unused-usage-roll-over) for the current policy.
