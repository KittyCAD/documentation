...
## Why the World Needed [One More Geometry Engine](/research/zoo-cad-engine-overview)
...
* **Text-to-CAD ML:** 20 free credits per month for every user on our Free tier.[^billing-update-2025]
...
[^billing-update-2025]: Update September 26, 2025: Text-to-CAD usage now bills per second at the same $0.50/min rate. Details live in [Per-second billing, same price, fairer math](/blog/per-second-billing).
