...
Today **Zoo Design Studio v1** is [live](https://zoo.dev/modeling-app/download).
...
[^2]: Parasolid, D-Cubed and Siemens: The Heart of Your CAD Software Belongs
      to Another – Engineering.com. <https://www.engineering.com/parasolid-d-cubed-and-siemens-the-heart-of-your-cad-software-belongs-to-another/>
...
[^7]: Siemens owns Parasolid, the kernel used by SolidWorks. - Engineering.com.
<https://www.engineering.com/what-is-a-geometric-modeling-kernel/>
[^8]: Shaping Up Spatial’s ACIS: Catching Up to Parasolid – Engineering.com. <https://www.engineering.com/shaping-up-spatials-acis-geometric-kernel-catching-up-to-parasolid/>
[^9]: This blog post was intended for our more mechanically inclined audience. Our geometry engine also has a full modern API and we have SDKs you can use to interact with it in any language. <https://zoo.dev/docs>
[^10]: Zoo Design Studio (the application layer, not the engine) is open source. <https://github.com/kittycad/modeling-app>
[^11]: B-rep vs Imported Mesh for Milling Smoothness – Autodesk Fusion forum
      Thread. <https://forums.autodesk.com/t5/fusion-manufacture/brep-vs-imported-mesh-for-milling-smoothness/td-p/8803359>
