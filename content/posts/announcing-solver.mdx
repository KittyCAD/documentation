...
![Rhombus sketch, showing the KCL code for it](/documentation-assets/announcing-solver/ugly_kcl.png)
...
![KCL refactored to be more readable](/documentation-assets/announcing-solver/pretty_kcl.png)
