...
[^1]: A good example of this is our [demo PR](https://github.com/KittyCAD/kcl-samples/pull/13) that takes a small change in a KittyCAD-language script and outputs both a STEP file and a image, but in future these pipelines will also encompase automated checks such as FEM.