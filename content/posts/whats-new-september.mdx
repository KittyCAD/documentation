...
excerpt: All the latest updates from the past month including Text-to-CAD reasoning, new panels layout, and experimental conics/ellipses.
date: '2025-09-03'
author:
    name: Adam Chalmers
...
![The new Text-to-CAD panel](/documentation-assets/whats-new-september/ttc_pane.png)
...
![See the LLM's reasoning](/documentation-assets/whats-new-september/ttc_reasoning_pane.png)
