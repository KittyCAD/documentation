...
excerpt: All the latest updates from the past month, including better Text-to-CAD, sharper graphics, sketching in more places, and a more powerful parser.
date: '2025-08-05'
author:
    name: Adam Chalmers
...
When we replaced the simple Text-to-CAD model with our new parametric model, we removed the old Text-to-CAD website and instead moved all our ML tooling into Zoo Design Studio. That annoyed a lot of our old users, so we recently put it back. You can now visit [text-to-cad.zoo.dev](https://app.zoo.dev/) *(Text-To-Cad has been replaced by [Zookeeper](https://zoo.dev/zookeeper), the conversational CAD agent natively integrated into Zoo Design Studio.)* to get the old Text-to-CAD experience back.
...
![Error chart showing errors dropping and success rising](/documentation-assets/whats-new-august/ml_errors.png)
...
![Extruded box and cylinder, all red](/documentation-assets/whats-new-august/all_red.png)
...
![Extruded box is silver, cylinder is red](/documentation-assets/whats-new-august/part_red.png)
...
<video width="320" height="240" controls>
  <source src="/documentation-assets/whats-new-august/inner_faces_video.mp4" type="video/mp4" poster="/documentation-assets/whats-new-august/neg_faces.png"/>
</video>
...
![Mouse trap with a spring that bulges out weirdly](/documentation-assets/whats-new-august/helix0.png)
...
![Mouse trap with normal spring](/documentation-assets/whats-new-august/helix1.png)
...
![Cylinder not being subtracted](/documentation-assets/whats-new-august/sub0.png)

But now it does!

![Cylinder has been subtracted](/documentation-assets/whats-new-august/sub1.png)
...
![Cylinder perfectly bisected by a cube](/documentation-assets/whats-new-august/sub2.png)

But now it works just fine!

![Cylinder perfectly bisected by a cube then subtracted](/documentation-assets/whats-new-august/sub3.png)
...
![Blurry sketch lines](/documentation-assets/whats-new-august/lines0.png)
...
![Sharp sketch lines](/documentation-assets/whats-new-august/lines1.png)
...
![Variables panel](/documentation-assets/whats-new-august/vars0.png)
...
![Variables panel, showing all variables up to the error](/documentation-assets/whats-new-august/vars1.png)
...
<video width="320" height="240" controls>
  <source src="/documentation-assets/whats-new-august/optional_args.mp4" type="video/mp4" poster="/documentation-assets/whats-new-august/optional_args.png"/>
</video>
