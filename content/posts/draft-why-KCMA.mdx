...
<Video speed={1.5} autoPlay={false} controls={true} loop={false} muted={false} src="/documentation-assets/why-kcma-blog/abstraction-demo.mp4" />
...
<Video speed={1.5} autoPlay={false} controls={true} loop={false} muted={false} src="/documentation-assets/why-kcma-blog/editor-scene-link.mp4" />
