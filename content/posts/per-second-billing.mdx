...
[^credit-rounding]: The UI expresses credits with a rounded $0.0083 per-second constant so the numbers stay friendly. That truncated rate slightly overstates the seconds you see (for example 1205 seconds ≈ $10 and 6024 seconds ≈ $50) compared with the exact $1/120 math. Your invoice still uses the precise rate and Half-Up rounding.
