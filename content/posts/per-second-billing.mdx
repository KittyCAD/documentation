...
**TL;DR:** We now bill **per second** at the **exact same rate as before**: **$0.50 per minute**, billed per second, which is **$1/120 per second** (about $0.008333). We **round Half-Up to the nearest cent per call** after the calculation, we never round your time. Included credit dollars are unchanged, only the unit changes to **seconds**. Two-week notice: starting **October 13, 2025**, calls under 10 seconds will be billed per second as well.
...
* **Credits are now in seconds:** Same dollars, different unit so you do not see fractional credits.
  ...
  * Free: **$10** monthly credit becomes **1205 seconds** (20 minutes).
  * Plus: **$50** monthly credit becomes **6024 seconds** (100 minutes). This plan is a steal since it only costs $20/month.
...
* **Short calls policy:** Historically, sub-10-second calls were not billed. Starting **October 9, 2025**, we will bill them per second with the same rate and rounding.
...
Most users do nothing. Your invoice lines simply show per-second items with cent rounding.
...
Seconds are concrete and easy to reason about. Also nicer for client code than 13.37 credits.

**When do short calls start getting billed**
Starting **October 9, 2025**, sub-10-second calls are billed per second with the same rounding.
