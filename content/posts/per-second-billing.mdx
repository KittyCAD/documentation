...
* **Effective date:** As of **September 29, 2025**, any call lasting 10 seconds or longer is billed per second.
...
Per-second billing for calls **10 seconds and up** started today, **September 29, 2025**. Starting **October 13, 2025**, sub-10-second calls are billed per second with the same rounding.
