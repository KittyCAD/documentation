...
Today we are excited to share [Text-to-CAD](https://app.zoo.dev/) with you! *(Text-To-Cad has been replaced by [Zookeeper](https://zoo.dev/zookeeper), the conversational CAD agent natively integrated into Zoo Design Studio.)*
...
clouds, we generate B-Rep[^1] surfaces. So you can import a STEP file from Text-to-CAD
...
you can edit it in our [Modeling App](https://zoo.dev/modeling-app/download)!
...
![involute helical gear with 36 teeth](/images/zookeeper/gear.png)

- "a 9 pointed star"

![a 9 pointed star](/images/zookeeper/star.png)

- "create a plate with 4 holes near each corner and rounded corners"

![create a plate with 4 holes near each corner and rounded corners](/images/zookeeper/plate.png)

- And one we thought was funny, tis the season: "a sketch of a christmas tree with a star on top"

![a sketch of a christmas tree with a star on top](/images/zookeeper/tree.png)

- A fun one using emoji in discord...

![gear with teeth](/images/zookeeper/discord-gear.png)

- One in french, "un cube avec un chamfer du bord haut"

![un cube avec un chamfer du bord haut](/images/zookeeper/french-cube.png)
...
[Text-to-CAD UI](https://app.zoo.dev/) *(Text-To-Cad has been replaced by [Zookeeper](https://zoo.dev/zookeeper), the conversational CAD agent natively integrated into Zoo Design Studio.)* to try it out today.
