...
-   **Reusable Designs with Code for CAD**: For some engineers, they take a code-first approach to CAD. Instead of designing a one-off design in their CAD GUI today, they script a more generalized design. This allows them to include complex logic, programatically link to design requirements, and build a library of design modules that they can reuse.
