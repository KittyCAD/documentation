...
Last month, we launched our new conversational CAD assistant, [Zookeeper](https://zoo.dev/docs/zoo-design-studio/zookeeper)! We've given it a major upgrade: you can now upload files to Zookeeper and it will analyze them and incorporate them into your design. Here's a few ways you could use this:
