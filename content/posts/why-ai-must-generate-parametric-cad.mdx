...
If you're curious how ZOO uses AI to generate B-rep models, learn more about [KCL, our code CAD language](https://zoo.dev/docs/kcl-book/intro.html). From there, you can dive into the [KCL language reference](https://zoo.dev/docs/kcl-lang), the [KCL standard library](https://zoo.dev/docs/kcl-std), and [CAD samples with KCL code](https://zoo.dev/docs/kcl-samples?category=All).
