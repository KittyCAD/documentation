...
We think the hardware design industry needs a new layer of people who focus on those underlying assumptions and keep them up-to-date as the industry finds new and better ways of making software.
...
This development model is table stakes for the software industry, and we are proving that it can work for hardware design tool companies too. We have been thrilled to see community members already contributing improvements to the Modeling App, as well as ideas and feedback on our roadmap. I can’t wait to see a specialized modeling app get made based on KCMA: if you’re building one, tag me on GitHub with any UX questions!
