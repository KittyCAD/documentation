...
<div style={{ display: 'grid', gridTemplateColumns: '64px minmax(0, 1fr)', alignItems: 'start', gap: '1rem', margin: '1.5rem 0' }}>
    <img
        src="/documentation-assets/makeathon-mersenne-clavichord/mason-malone.jpg"
        alt="Mason Malone"
        width={64}
        height={90}
        style={{ width: '64px', height: 'auto', borderRadius: '8px', margin: 0 }}
    />
    <p style={{ margin: 0 }}>
