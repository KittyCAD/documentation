...
coverImage: '/documentation-assets/meta-images/ZDS-Makeathon-blog.png'
date: '2026-08-27'
author:
    name: Jenna Bryant
    picture: '/documentation-assets/jennabryant.jpeg'
ogImage:
    url: '/documentation-assets/meta-images/ZDS-Makeathon-blog.png'
tags: ['New', 'Zoo Design Studio', 'Case Study', 'KCL Code']
---
...
<figure data-image-layout="portrait-scan">
    <img
...
<figure>
    ...
    />
    <figcaption>
        Peter Bavington's physical reconstruction of Mersenne's clavichord. Photo: Peter Bavington. <a href="https://www.peter-bavington.co.uk/mersenneintro.htm">The Mersenne Clavichord Project</a>.
    </figcaption>
</figure>
...
<div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'center', gap: '1.5rem', margin: '1.5rem 0' }}>
    <img
        src="/documentation-assets/makeathon-mersenne-clavichord/mason-malone.jpg"
        alt="Mason Malone"
        width={114}
        height={160}
        style={{ width: '114px', height: 'auto', borderRadius: '8px', margin: 0 }}
    />
    <p style={{ flex: '1 1 240px', margin: 0 }}>
        Mason is a software developer in Seattle with over 20 years of experience. Outside his day job at Adobe, he's a maintainer for several open-source projects and is passionate about early keyboard instruments.
    </p>
</div>
