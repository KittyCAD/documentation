...
<figure style={{ margin: '2rem auto 2.5rem', textAlign: 'center' }}>
    <img
        src="/documentation-assets/makeathon-mersenne-clavichord/mersenne-1636-clavichord-drawing-public-domain.jpg"
        alt="Marin Mersenne's 1636 diagram of the manichordion, or clavichord"
        style={{ display: 'block', margin: '0 auto', maxWidth: '100%' }}
    />
    <figcaption style={{ color: 'inherit', fontSize: '0.95rem', lineHeight: '1.5', marginTop: '0.75rem', opacity: 0.72 }}>
        Marin Mersenne's diagram of the manichordion, or clavichord, from <cite>Harmonie universelle</cite> (1636), Third Book of Stringed Instruments, Proposition IV, p. 115. Scan: <a href="https://gallica.bnf.fr/ark:/12148/bpt6k15111009/f1092.item">Bibliothèque nationale de France</a>, via <a href="https://commons.wikimedia.org/w/index.php?curid=171021767">Wikimedia Commons</a>. Public domain.
    </figcaption>
</figure>
...
<figure style={{ margin: '2rem auto 2.5rem', textAlign: 'center' }}>
    <img
        src="/documentation-assets/makeathon-mersenne-clavichord/clavichord-model.png"
        alt="Mason Malone's first-place model of Mersenne's clavichord"
        style={{ display: 'block', margin: '0 auto', maxWidth: '100%' }}
    />
    <figcaption style={{ color: 'inherit', fontSize: '0.95rem', lineHeight: '1.5', marginTop: '0.75rem', opacity: 0.72 }}>
...
<figure style={{ margin: '2rem auto 2.5rem', textAlign: 'center' }}>
    <img
        src="/documentation-assets/makeathon-mersenne-clavichord/clavichord-strings-and-keyboard.png"
        alt="A close view of Mason Malone's clavichord model in Zoo Design Studio, showing its keyboard, strings, bridges, and tangent layout"
        style={{ display: 'block', margin: '0 auto', maxWidth: '100%' }}
    />
    <figcaption style={{ color: 'inherit', fontSize: '0.95rem', lineHeight: '1.5', marginTop: '0.75rem', opacity: 0.72 }}>
