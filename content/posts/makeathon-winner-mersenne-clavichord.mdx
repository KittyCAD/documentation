...
coverImage: '/documentation-assets/makeathon-mersenne-clavichord/clavichord-in-zoo-design-studio.png'
date: '2026-08-25'
author:
    name: Jenna Bryant
    picture: '/documentation-assets/jennabryant.jpeg'
ogImage:
    url: '/documentation-assets/makeathon-mersenne-clavichord/clavichord-in-zoo-design-studio.png'
...
{/* TODO: Replace or supplement this render with a larger hero image or alternate angle if one is available. */}
...
![The clavichord project open in Zoo Design Studio, with KCL on the left and Zookeeper on the right.](/documentation-assets/makeathon-mersenne-clavichord/clavichord-in-zoo-design-studio.png)

{/* TODO: Add one or two more images to break up the second half of the post, ideally showing the source drawing, string layout, or tangent geometry. */}
...
He initially gave Zookeeper Mersenne's drawing and original French description and asked for a model. The output was incoherent. The source material was too sparse and ambiguous, a problem that had challenged human scholars for centuries.
