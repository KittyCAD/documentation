...
`cd` stands for change directory. Once you hit return, you will be working inside the litterbox-main folder. For another example, let's say you put your folder you downloaded in a folder called `KittyCADPractice` within the `Documents` folder. This would look like so:

```
cd ~/Documents/KittyCADPractice/litterbox-main
```
