...
excerpt: In this tutorial we'll walk through the basics of KittyCAD and using the API with Javascript
---
...
```    
cd ~/Desktop/tutorial-files-js-main
```

`cd` stands for change directory. Once you hit return, you will be working inside the tutorial-files-js-main folder. For another example, let's say you put your folder you downloaded in a folder called `KittyCADPractice` within the `Documents` folder. This would look like so:

```
cd ~/Documents/KittyCADPractice/tutorial-files-js-main
```
...
```js data-file="public/litterbox_assets/tutorials/beginner_tutorial/convert.js"
```
