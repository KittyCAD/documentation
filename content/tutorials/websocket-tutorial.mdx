...
While you follow this tutorial, feel free to reference our <a href="https://zoo.dev/docs/developer-tools/api/modeling/open-a-websocket-which-accepts-modeling-commands?lang=python" target="_blank" rel="noopener noreferrer">API Docs</a> or our <a href="https://python.api.docs.zoo.dev/_autosummary/kittycad.models.html#module-kittycad.models" target="_blank" rel="noopener noreferrer">Python Library</a>.
